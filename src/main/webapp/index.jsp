...
<body>
	...
	<div id="carouselAutoplaying"
		...
		<button class="carousel-control-prev" type="button"
			...
			<span class="carousel-control-prev-icon" aria-hidden="true"
				style="color: blue;"></span> <span class="visually-hidden">Previous</span>
		</button>
	...
	<div class="container-fluid py-3 px-3" style="background: #e3f7fc;">
				...
				<a href="viewProduct.jsp?pid=<%=productList.get(i).getProductId()%>"
					...
					<div class="card h-100">
						...
						<div class="card-body">
							...
							<div class="container text-center">
								<span class="real-price"><%=productList.get(i).getProductPriceAfterDiscount()%> vnd</span>
								&ensp;<span class="product-price"><%=productList.get(i).getProductPrice()%> vnd
	...
	<div class="container-fluid py-3 px-3" style="background: lavenderblush;">
		<h3>HOT HOT HOT</h3>
		<div class="row row-cols-1 row-cols-md-4 g-3">
			<%
				...
				<a href="viewProduct.jsp?pid=<%=topDeals.get(i).getProductId()%>"
					...
					<div class="card h-100">
						...
						<div class="card-body">
							...
							<div class="container text-center">
								<span class="real-price"><%=topDeals.get(i).getProductPriceAfterDiscount()%> vnd</span>
								&ensp;<span class="product-price"><%=topDeals.get(i).getProductPrice()%> vnd
